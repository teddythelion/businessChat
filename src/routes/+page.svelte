...
<div class="flex flex-col pt-4 w-full px-8 items-center gap-2">
	...
	<div class="h-[500px] w-full bg-black rounded-md p-4 overflow-y-auto flex flex-col gap-4">
	...
	>
		...
		<button type="submit" class="btn btn-accent btn-group-vertical shadow-xl"> Send </button>
	</form>
</div>
